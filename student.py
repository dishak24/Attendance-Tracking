...
class Student:
    def __init__(self,root):
        ...
        title_lbl=Label(bg_img,text="Student Pannel", font=("tahoma",30,'bold'), bg="white",fg="navyblue")
        title_lbl.place(x=0, y=0, width=1280,height=45)
        

        main_frame=Frame(bg_img,bd=2,bg="white")
        main_frame.place(x=10,y=55,width=1260,height=600)

        #************************left label frame*****************************

        Left_frame=LabelFrame(main_frame,bd=2,bg="white",relief=RIDGE,text="Student Details",font=("tahoma",14,"bold"))
        Left_frame.place(x=10,y=10,width=615,height=470)

        #@@@@@@@@@@@@current course information@@@@@@@@@

        current_course_frame=LabelFrame(Left_frame,bd=2,bg="white",relief=RIDGE,text="Current Course Information",font=("times new roman",12,"bold"))
        current_course_frame.place(x=3,y=0,width=605,height=115)
        ...
        dep_combo=ttk.Combobox(current_course_frame,textvariable=self.var_dept,font=("times new roman",12,"bold"),state="readonly",width=17)  
        dep_combo["values"] =("Select Department","IT", "Computer","EXTC","Civil","Chemical","Electrical","Mechanical","Petrochemical","Instrumentation")
        dep_combo.current(0)
        ...
        course_combo["values"] =("Select Course","BTECH","BE","BCA","BCS")
        ...
        semester_combo["values"] =("Select Semester","Semester-1","Semester-2","Semester-4","Semester-6","Semester-8")
        ...
        class_student_frame=LabelFrame(Left_frame,bd=2,bg="white",relief=RIDGE,text="Class Student  Information",font=("tahoma",14,"bold"))
        class_student_frame.place(x=3,y=130,width=605,height=310)
        ...
        studentID_entry=ttk.Entry(class_student_frame,textvariable=self.var_std_id, width=17,font=("times new roman",12))
        ...
        div_combo=ttk.Combobox(class_student_frame,textvariable=self.var_div,width=15,font=("times new roman",12),state="readonly")  
        ...
        gender_combo=ttk.Combobox(class_student_frame,textvariable=self.var_gender, font=("times new roman",12),state="readonly",width=15)  
        ...
        dob_div_entry=ttk.Entry(class_student_frame,textvariable=self.var_dob, width=17,font=("times new roman",12))
        dob_div_entry.grid(row=2,column=3,padx=10,pady=5,sticky=W)
        ...
        radiobtn1=ttk.Radiobutton(class_student_frame,variable=self.var_radio1, text="Take Photo Sanple",value="Yes",width=17)
        radiobtn1.grid(row=6,column=0,padx=10,pady=5,sticky=W)
        
        
        self.var_radio2=StringVar()
        radiobtn2=ttk.Radiobutton(class_student_frame,variable=self.var_radio2, text="No Photo Sanple",value="No",width=17)
        ...
        delete_btn=Button(btn_frame,text="Delete",command=self.delete_data,width=16,font=("times new roman",12,"bold"),bg="red",fg="white")
    ...
    #*************************right label frame**********************
        ...
        Right_frame=LabelFrame(main_frame,bd=2,bg="white",relief=RIDGE,text="Student Details",font=("tahoma",14,"bold"))
        Right_frame.place(x=630,y=10,width=615,height=470)

        #@@@@@ search system @@@@@@@@@
        Search_frame=LabelFrame(Right_frame,bd=2,bg="white",relief=RIDGE,text="Search System",font=("times new roman",12,"bold"))
        Search_frame.place(x=3,y=0,width=605,height=70)
        
        
        search_label=Label(Search_frame,text="Search By:",font=("times new roman",13,"bold"),bg="violet")
        ...
        search_combo["values"] =("Select","Roll No","Phone No","Year","Email")
        ...
        table_frame.place(x=3,y=100,width=605,height=336)
        
        scroll_x=ttk.Scrollbar(table_frame,orient=HORIZONTAL)
        scroll_y=ttk.Scrollbar(table_frame,orient=VERTICAL)
        
        self.student_table=ttk.Treeview(table_frame,column=("dept","course","year","sem","id","name","div","roll no","gender","dob","email","phone","address","teacher","photo"),xscrollcommand=scroll_x.set,yscrollcommand=scroll_y.set)
        ...
        if self.var_dept.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:
                ...
                my_cursor.execute("insert into student values(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)",(
                                                                                                                    self.var_dept.get(),                                                                                                                self.var_course.get(),
                                                                                                                    self.var_year.get(),
    ...
    def generate_dataset(self):
        if self.var_dept.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:
                ...
                for x in myresult:
                    id+=1
                my_cursor=conn.cursor("update student set Dept=%s,course=%s,year=%s,Semester=%s,Student_id=%s,Name=%s,Division=%s,Roll=%s,Gender=%s,Dob=%s,Email=%s,Phone=%s,Address=%s,Teacher=%s,PhotoSample=%s where Student_id=%s",(
